...
import 'bloc/search_cat_bloc.dart';
import 'bloc/search_cate_event.dart';
import 'bloc/search_cate_state.dart';

class CustomSubCatSearchDelegate extends SearchDelegate
{
  final String rootId;

  CustomSubCatSearchDelegate({required this.rootId});
